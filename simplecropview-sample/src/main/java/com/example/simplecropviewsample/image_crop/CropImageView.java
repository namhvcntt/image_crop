package com.example.simplecropviewsample.image_crop;
...
import com.example.simplecropviewsample.R;
import com.example.simplecropviewsample.image_crop.animation.SimpleValueAnimator;
import com.example.simplecropviewsample.image_crop.animation.SimpleValueAnimatorListener;
import com.example.simplecropviewsample.image_crop.animation.ValueAnimatorV14;
import com.example.simplecropviewsample.image_crop.animation.ValueAnimatorV8;
import com.example.simplecropviewsample.image_crop.callback.Callback;
import com.example.simplecropviewsample.image_crop.callback.CropCallback;
import com.example.simplecropviewsample.image_crop.callback.LoadCallback;
import com.example.simplecropviewsample.image_crop.callback.SaveCallback;
import com.example.simplecropviewsample.image_crop.util.Utils;
...
//        if (mShowGuide) drawGuidelines(canvas);
    ...
    private void drawHandles(Canvas canvas) {
        ...
        for (int i = 0; i < 4; i++) {
            drawArrow(canvas, mPaintFrame, i);
        }
    }

    private void drawArrow(Canvas canvas, Paint paint, int position) {
        float x, y;
        switch (position) {
            case 0: {
                x = mFrameRect.left;
